...
if(isset($_POST['submit'])){
    ...
    if($_POST['submit']=="Sign up"){
        ...
        $registertime1 = date("Y-m-d H:i:s");
        ...
        if((!$_POST['male'] )and (!$_POST['female'])){
            $error .= "<br/>Please check your gender";
        }else if($_POST['male']=='on')
        {
            $_POST['gender']='male';
        ...
        if($error){
            ...
            if($checkexistrows >= 1){
                $error = "This Username has been registered, do you want to LOG IN?";
            }else{



                $addnewuserquery = "INSERT INTO `user`(`Email`, `Password`,`Username`,`Age`,`Gender`,`Phone`,`Address`,`Sign_up_Time`,`LastLogin`)
                VALUES ('".$_POST['email']."','".$_POST['password']."',
                '".$_POST['Username']."', '".$_POST['age']."','".$_POST['gender']."', '".$_POST['phone']."','".$_POST['address']."','".$registertime1."','".$registertime2."')";
                ...
                header('Location:home.php?UID='.$_SESSION['id']);
